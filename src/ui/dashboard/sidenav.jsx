      ...
      <div className={styles["main_menu_container"]}>
        <ul className={selectedMainMenu === "dashboard" ? styles.selected : ""}>
          <div onClick={() => selectMainMenu("dashboard")}>
            <Link
              href="/dashboard"
              className={`${styles["main_menu"]} ${styles["selected"]}`}
            >
        ...
        <ul
          className={`${styles["list_link"]} ${
            selectedMainMenu === "individual-applicants"
        ...
        {showIndividualLinks && (
          <div className={styles["list_item"]} onClick={handleCloseSidebar}>
            <Link
              href="/"
              className={
                selectedIndividualSubMenu === "profile"
                  ? styles.selectedListLink
                  : ""
              }
              onClick={() => selectSubLinkOfIndividual("profile")}
            >
              Profile
            </Link>
            <Link
